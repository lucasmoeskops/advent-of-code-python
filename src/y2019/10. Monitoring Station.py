...
__date__ = "2021-01-24"
__summary__ = "Build giant laser to kill asteroids for elves"
...
print(max(map(partial(sight_count, asteroids), asteroids)))
...
print(target_asteroid[0] * 100 + target_asteroid[1])
